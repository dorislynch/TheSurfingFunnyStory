...
Pod::Spec.new do |s|
  s.name         = "RNTheSurfingFunnyStory"
  s.version      = "1.0.1"
  s.summary      = "RNTheSurfingFunnyStory"
  s.description  = <<-DESC
                  RNTheSurfingFunnyStory
                   DESC
                   s.homepage     = "https://github.com/dorislynch/TheSurfingFunnyStory"
                   s.license      = "MIT"
                   # s.license      = { :type => "MIT", :file => "FILE_LICENSE" }
                   s.author             = { "author" => "author@domain.cn" }
                   s.platform     = :ios, "7.0"
                   s.source       = { :git => "https://github.com/dorislynch/TheSurfingFunnyStory.git", :tag => "master" }
